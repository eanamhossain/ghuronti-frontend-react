...
import './Flight.css'
import Cox from '../../images/1.png';
import Shylet from '../../images/2.png';
import Saint from '../../images/3.png';
import Sundarban from '../../images/4.png';
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import Slider from "react-slick";
import Adsection from '../Shared/AdSecton/Adsection';
import TrendingInternational from '../Shared/TrendingInternation/TrendingInternational';
    ...
    const data = [
        {
            ...
            price: 15000,
            image: Cox,
            description: "Cox's Bazar is a coastal town in Bangladesh known for having the world's longest natural sandy beach, stretching over 120 kilometers. It is a popular tourist destination with breathtaking views of the Bay of Bengal and offers activities like surfing, sunbathing, and visiting nearby attractions such as Himchari National Park and St. Martin's Island."
        },
        {
            name: 'Shylet',
            price: 3000,
            image: Shylet,
            description: "Sylhet is a city in northeastern Bangladesh, known for its lush green landscapes, tea gardens, and the famous Sylheti cuisine. It is a culturally rich city with attractions like the Shahjalal Shrine and the beautiful Ratargul Swamp Forest."
        },
        {
            name: 'Saint Martin',
            price: 7500,
            image: Saint,
            description: "Saint Martin's Island is a small coral island located in the Bay of Bengal, near the southernmost part of Bangladesh. It is renowned for its pristine beaches, crystal-clear turquoise waters, and vibrant marine life, making it a popular destination for snorkeling, diving, and beach lovers."
        },
        {
            name: 'Sundarban',
            image: Sundarban,
            price: 10000,
            description: "The Sundarbans is a vast mangrove forest located in Bangladesh and India, known for its rich biodiversity and being home to the Royal Bengal Tigers. It is a UNESCO World Heritage Site and provides crucial habitat for numerous species, making it a significant ecological treasure."
        },
    ]
    var settings = {
        dots: true,
    ...
    return (
        <div className=''>
            ...
            <div className="hajjButton">
              ...
              <Link to="/hajj" style={{ textDecoration: "none" }}><p>Hajj & Umrah</p></Link>
            </div>
            <div className="optionButtonActive" >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={40}
                height={40}
            ...
            <div className="optionButton" >
                    ...
                    <div className="heroboxContent">
                        <div className="hajjPackage">
                            <div className="hajjPackageButton" onClick={() => setHazzSubBUttonActive(0)}>
                                <p className="hajjButtonSubActive" style={{ borderBottom: hazzSubButtonActive === 0 ? "3px solid #4AB449" : "none" }}>One Way</p>
                            </div>
                            <div className="hajjPackageButton" onClick={() => setHazzSubBUttonActive(1)}>
                                <p className="hajjButtonSubActive" style={{ borderBottom: hazzSubButtonActive === 1 ? "3px solid #4AB449" : "none" }}>Round Trip</p>
                            </div>
                            <div className="hajjPackageButton" onClick={() => setHazzSubBUttonActive(2)}>
                                <p className="hajjButtonSubActive" style={{ borderBottom: hazzSubButtonActive === 2 ? "3px solid #4AB449" : "none" }}>Multi City</p>
                            </div>
                        </div>
                        <div className="hajjPackagesButton">
                            <div className="navDIv">
                                <div className="inputMain">
                                    <p>Flying From</p>
                                    <input type="text" className="locationInput" placeholder='City or Airport' />
                                </div>
                                <div className="inputMain">
                                    <p>Flying To</p>
                                    <input type="text" className="locationInput" placeholder='City or Airport' />
                            ...
                            <div className="navDIv">
                                <div className="inputMainDate">
                                    <div className="dateFirst">
                                        <p>Depart To</p>
                                        <input type="date" className="locationInput" placeholder='City or Airport' />
                                    </div>
                                    <div className="dateFirst">
                                        <p style={{ marginLeft: "10px" }}>Return To</p>
                                        <input type="date" style={{ marginLeft: "10px" }} className="locationInput" placeholder='City or Airport' />
                                    </div>
                                </div>
                                <div className="inputMain">
                                    <p>Passengers & Cabin Class</p>
                                    <input type="text" className="locationInput" placeholder='1 Person   ' />
                                </div>
                            </div>

                        </div>
                        <div className="hajjPackagesButton">
                            <button className="bookButton">Search Flights</button>
                        </div>
                    </div>
                </div>
                <div className='bestPlaceVisit'>
                    <h1 className="trending">Best Places To Visit In Bangladesh</h1>
                    <p className="bestPlacePara">
                    Bangladesh is a South Asian country with a rich cultural heritage <br /> and natural beauty. It is home to the world's largest mangrove <br /> forest,  culture, and natural beauty.
                    </p>
                    <div className="bestplaceVisitMain">
                        <Slider {...settings}>
                            {
                                data && data.map((item, index) => (
                                    <div className='bestPlaceCard'>
                                       <div className="card">
                                            <img src={item.image} alt="img" className='bestPlaceimage' />
                ...
                <Adsection/>
                <h1 className="trending">Trending International Destinations</h1>
                    <p className="bestPlacePara">
                    The world is now just a hop, skip and jump away and here’s how <br /> you can make your travel easier and better. 
                    </p>
