        ...
        <div>
            ...
            <div className="home-main">
                ...
                <div className="visaPageMain">
                    ...
                    <div className="countryBox">
                        {
                            data && data.map((item, index) => (
                                <div className="countryFirstLine" key={index}>
                    ...
                    <div className="visaContnet">
                        {
                            dataTwo && dataTwo.map((item, index) => (
                                <div className="visaIndiCon" key={index}>
                                    <img src={item.img} alt='flag' />
                                    <div className="infoDiv">
                                        <h2>{item.name}</h2>
                                        {
                                            item.benifit.map((items, index) => (
                                                <div className="liInfo" key={index}>
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width={20}
                                                        height={20}
