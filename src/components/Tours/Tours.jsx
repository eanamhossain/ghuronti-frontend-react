            ...
            <div className="home-main">
                ...
                <div className="heroBoxMain">
                    ...
                    <div className="heroboxContent">
                        <div className="hajjPackagesButton">
                            <div className="navDIv">
                                <div className="inputMain">
                                    <p>Where To ?</p>
                                    <input type="text" className="locationInput" placeholder='Enter your city' />
                                </div>
                        ...
                        <div className="hajjPackagesButton">
                            <button className="bookButton">Search Tours</button>
                        </div>
                    </div>
                </div>
                ...
                <h1 className="trending">Trending International Destinations</h1>
                    ...
                    <h1 className="trending">Trending Indian Destinations</h1>
                    <p className="bestPlacePara">
                    India’s diverse topography, history and culture offers enough  <br /> experiences to fulfil any type of wanderlust.
                    </p>
